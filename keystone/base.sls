...
{% set nova_api_hosts = salt['publish.publish']('D@openstack.nova.api:*', 'data.getval', 'openstack.nova.api', expr_form='compound', timeout=1).values() %}
{% set cinder_api_hosts = salt['publish.publish']('D@openstack.cinder.api:*', 'data.getval', 'openstack.cinder.api', expr_form='compound', timeout=1).values() %}
